...
if ( !function_exists( 'rb_blog_two_post_thumbnail_cutom' ) ) {
	...
	add_action( 'rb_blog_two_post_thumbnail', 'rb_blog_two_post_thumbnail_cutom');
}
...
if ( !function_exists( 'rb_blog_two_author_meta_custom' ) ) {
    ...
    add_action( "rb_blog_two_author_meta", "rb_blog_two_author_meta_custom" );
}
...
if ( !function_exists( 'rb_blog_two_date_meta_custom' ) ) {
    ...
    add_action( "rb_blog_two_date_meta", "rb_blog_two_date_meta_custom" );
}
...
if ( !function_exists( 'rb_blog_two_cat_meta_custom' ) ) {
    ...
    add_action( "rb_blog_two_cat_meta", "rb_blog_two_cat_meta_custom" );
}
	...
	function rb_blog_two_tag_meta_custom() {
		...
		if ( has_tag() ) { 
            ...
            <span class="entry-tag-meta">
                ...
                <?php echo wp_kses_post( $tags_list, 'rb-blog-two' ); ?>
            </span>
            <?php			
		}		
	}
    add_action( 'rb_blog_two_tag_meta', 'rb_blog_two_tag_meta_custom' );
}
...
if ( !function_exists( 'rb_blog_two_comments_meta_custom' ) ) {
    ...
    add_action( "rb_blog_two_comments_meta", "rb_blog_two_comments_meta_custom" );
}
...
if ( !function_exists( 'rb_blog_two_edit_meta_custom' ) ) {
    ...
    add_action( "rb_blog_two_edit_meta", "rb_blog_two_edit_meta_custom" );
}
...
***** 10. Post Pagination Output *****
*************************************/
if ( !function_exists( 'rb_blog_two_pagination_custom' ) ) {
    function rb_blog_two_pagination_custom() {
    ...
    add_action( 'rb_blog_two_pagination', 'rb_blog_two_pagination_custom' );
}

/********************************************
***** 11. Single Post Pagination Output *****
********************************************/
if ( !function_exists( 'rb_blog_two_single_post_pagination_custom' ) ) {
	function rb_blog_two_single_post_pagination_custom() {
		$page_link = array(
	...
	add_action( 'rb_blog_two_single_post_pagination', 'rb_blog_two_single_post_pagination_custom' );
}
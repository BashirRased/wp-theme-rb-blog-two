...
***** 02. Font Awesome *****
***************************/
function rb_blog_two_fontawesome_css() {    
	wp_enqueue_style( 'font-awesome', FONT_AWESOME_CSS .'font-awesome.css', '', '6.4.2', 'all' );
}
add_action( 'wp_enqueue_scripts', 'rb_blog_two_fontawesome_css' );

/************************
***** 03. Bootstrap *****
************************/
function rb_blog_two_bootstrap_assets() {
	// Bootstrap CSS
    if ( is_rtl() ) {
...
add_action( 'wp_enqueue_scripts', 'rb_blog_two_bootstrap_assets' );

/*********************
***** 04. Swiper *****
*********************/
function rb_blog_two_swiper_assets() {
    // Swiper CSS
...
add_action( 'wp_enqueue_scripts', 'rb_blog_two_swiper_assets' );

/*********************************
***** 05. jQuery Nice Select *****
*********************************/
function rb_blog_two_nice_select_assets() {    
    // Nice Select CSS
...
add_action( 'wp_enqueue_scripts', 'rb_blog_two_nice_select_assets' );

/******************************
***** 06. jQuery meanMenu *****
******************************/
function rb_blog_two_mean_menu_assets() {    
    // Mean Menu
...
add_action( 'wp_enqueue_scripts', 'rb_blog_two_mean_menu_assets' );

/************************************
***** 07. Browser Config Assets *****
************************************/
function rb_blog_two_browser_config_assets() {
    // Normalize
...
add_action( 'wp_enqueue_scripts', 'rb_blog_two_browser_config_assets' );

/*****************************
***** 08. Conditional JS *****
*****************************/
function rb_blog_two_conditional_assets() {
...
add_action( 'wp_enqueue_scripts', 'rb_blog_two_conditional_assets' );
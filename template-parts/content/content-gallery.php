                        ...
                        <div class="swiper-wrapper">
                            ...
                            <?php if( !empty ( $gallery_img_1 ) ) : ?>
                                <figure class="swiper-slide">
                                    <img src="<?php echo esc_url($gallery_img_1['url']); ?>" alt="<?php echo esc_attr($gallery_img_1['alt'], 'rb-blog-two'); ?>" />
                                </figure>
                            <?php endif; ?>
                            ...
                            <?php if( !empty ( $gallery_img_2 ) ) : ?>
                                <figure class="swiper-slide">
                                    <img src="<?php echo esc_url($gallery_img_2['url']); ?>" alt="<?php echo esc_attr($gallery_img_2['alt'], 'rb-blog-two'); ?>" />
                                </figure>
                            <?php endif; ?>
                            ...
                            <?php if( !empty ( $gallery_img_3 ) ) : ?>
                                <figure class="swiper-slide">
                                    <img src="<?php echo esc_url($gallery_img_3['url']); ?>" alt="<?php echo esc_attr($gallery_img_3['alt'], 'rb-blog-two'); ?>" />
                                </figure>
                            <?php endif; ?>
                            ...
                            <?php if( !empty ( $gallery_img_4 ) ) : ?>
                                <figure class="swiper-slide">
                                    <img src="<?php echo esc_url($gallery_img_4['url']); ?>" alt="<?php echo esc_attr($gallery_img_4['alt'], 'rb-blog-two'); ?>" />
                                </figure>
                            <?php endif; ?>   
                            ...
                            <?php if( !empty ( $gallery_img_5 ) ) : ?>
                                <figure class="swiper-slide">
                                    <img src="<?php echo esc_url($gallery_img_5['url']); ?>" alt="<?php echo esc_attr($gallery_img_5['alt'], 'rb-blog-two'); ?>" />
                                </figure>
                            <?php endif; ?>
                        </div>

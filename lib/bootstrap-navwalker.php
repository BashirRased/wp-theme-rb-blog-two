...
if ( ! class_exists( 'RB_Blog_Two_Navwalker_Class' ) ) :
	/**
	 * RB_Blog_Two_Navwalker_Class class.
	 */
	class RB_Blog_Two_Navwalker_Class extends Walker_Nav_Menu {
		...
		public static function fallback( $args ) {
			...
			$fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( 'Add a menu', 'rb-blog-two' ) . '">' . esc_html__( 'Add a menu', 'rb-blog-two' ) . '</a></li>';
			$fallback_output .= '</ul>';
